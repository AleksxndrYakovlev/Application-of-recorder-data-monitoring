...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button_close
			// 
			this->button_close->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"button_close.BackgroundImage")));
			this->button_close->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Zoom;
			this->button_close->Location = System::Drawing::Point(1858, 12);
			this->button_close->Name = L"button_close";
			this->button_close->Size = System::Drawing::Size(34, 34);
